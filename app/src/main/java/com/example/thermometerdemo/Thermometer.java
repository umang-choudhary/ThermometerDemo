...
public class Thermometer extends View {
    ...
    private static final int GRADUATION_TEXT_SIZE = 12; // in sp
    private static float DEGREE_WIDTH = 30;
    private static final int NB_GRADUATIONS = 6;
    public static final float MAX_TEMP = 40, MIN_TEMP = -20;
    private static final float RANGE_TEMP = 60;
    private static final int NB_GRADUATIONS_F = 7;
    private static final float MAX_TEMP_F = 100, MIN_TEMP_F = -19;
    private static final float RANGE_TEMP_F = 119;
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        int thresholdColor = typedArray.getColor(R.styleable.Thermometer_thresholdColor, Color.GRAY);
        ...
        innerCircleRadius = middleCircleRadius - middleCircleRadius / 4;
        innerRectRadius = middleRectRadius - middleRectRadius / 4;
        ...
        thresholdPaint.setStrokeWidth(middleCircleRadius / 8);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (tmp - 1 <= innerEffectEndY) {
            if (startGraduation == 32) {
                canvas.drawLine(circleCenterX + outerRectRadius, tmp, circleCenterX + outerRectRadius + (DEGREE_WIDTH * 4), tmp, thresholdPaint);
            }
